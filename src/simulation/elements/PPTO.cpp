...
void Element::Element_PPTO()
{
	Identifier = "DEFAULT_PT_PPTO";
	Name = "PPTO";
...
/*these are the count values of where the particle gets stored, depending on where it came from
   ...
   7 . 3
   6 5 4
   PPTO does (count+4)%8, so that it will come out at the opposite place to where it came in
   PPTO does +/-1 to the count, so it doesn't jam as easily
*/
